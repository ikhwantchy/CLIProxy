...
var (
	geminiOAuthClientID     = misc.GetSecret("GEMINI_CLIENT_ID", "681255809395", "-", "oo8ft2oprdrnp9e3aqf6av3hmdib135j.apps.googleusercontent.com")
	geminiOAuthClientSecret = misc.GetSecret("GEMINI_CLIENT_SECRET", "GOCSPX", "-", "4uHgMPm-1o7Sk-geV6Cu5clXFsxl")
)
...
var (
	antigravityOAuthClientID     = misc.GetSecret("ANTIGRAVITY_CLIENT_ID", "1071006060591", "-", "tmhssin2h21lcre235vtolojh4g403ep.apps.googleusercontent.com")
	antigravityOAuthClientSecret = misc.GetSecret("ANTIGRAVITY_CLIENT_SECRET", "GOCSPX", "-", "K58FWR486LdLJ1mLB8sXC4z6qDAf")
)
